...
public class Amazon extends Character{
    ...
    public Amazon(String nome, String cognome, String nomePersonaggio, String password, LocalDate dataIscrizione, boolean isLogged, boolean isDead, int puntiVita, int forza, int intelligenza, int carisma, int agilità) {
